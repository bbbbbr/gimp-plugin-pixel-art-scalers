...
void scalers_init(void)
{
    ...
    scalers[index].scale[SCALEV_3X].factor = 3;
    snprintf(scalers[index].scale[SCALEV_3X].name, SCALER_STR_MAX, "3X");
    scalers[index].scale[SCALEV_4X].function = &scaler_hris_3x;
    ...
    // XBR
    index = SCALER_XBR;
    scalers[index].scale[SCALEV_2X].function = &xbr_filter_xbr2x;
    scalers[index].scale[SCALEV_2X].factor = 2;
    snprintf(scalers[index].scale[SCALEV_2X].name, SCALER_STR_MAX, "2X");
    scalers[index].scale[SCALEV_3X].function = &xbr_filter_xbr3x;
    scalers[index].scale[SCALEV_3X].factor = 3;
    snprintf(scalers[index].scale[SCALEV_3X].name, SCALER_STR_MAX, "3X");
    scalers[index].scale[SCALEV_4X].function = &xbr_filter_xbr4x;
    scalers[index].scale[SCALEV_4X].factor = 4;
    snprintf(scalers[index].scale[SCALEV_4X].name, SCALER_STR_MAX, "4X");
    ...
    // SCALEX
    index = SCALER_SCALEX;
    scalers[index].scale[SCALEV_2X].function = &scaler_scalex_2x;
    scalers[index].scale[SCALEV_2X].factor = 2;
    snprintf(scalers[index].scale[SCALEV_2X].name, SCALER_STR_MAX, "2X");
    scalers[index].scale[SCALEV_3X].function = &scaler_scalex_3x;
    scalers[index].scale[SCALEV_3X].factor = 3;
    snprintf(scalers[index].scale[SCALEV_3X].name, SCALER_STR_MAX, "3X");
    scalers[index].scale[SCALEV_4X].function = &scaler_scalex_4x;
    scalers[index].scale[SCALEV_4X].factor = 4;
    snprintf(scalers[index].scale[SCALEV_4X].name, SCALER_STR_MAX, "4X");
    ...
    scalers[index].scale[SCALEV_3X].factor = 3;
    snprintf(scalers[index].scale[SCALEV_3X].name, SCALER_STR_MAX, "3X");
    scalers[index].scale[SCALEV_4X].function = &gsample_4x;
    scalers[index].scale[SCALEV_4X].factor = 4;
    snprintf(scalers[index].scale[SCALEV_4X].name, SCALER_STR_MAX, "4X");
    ...
    scalers[index].scale[SCALEV_2X].function = &scaler_nearest_2x;
    scalers[index].scale[SCALEV_2X].factor = 2;
    snprintf(scalers[index].scale[SCALEV_2X].name, SCALER_STR_MAX, "2X");
    scalers[index].scale[SCALEV_3X].function = &scaler_nearest_3x;
    scalers[index].scale[SCALEV_3X].factor = 3;
    snprintf(scalers[index].scale[SCALEV_3X].name, SCALER_STR_MAX, "3X");
    scalers[index].scale[SCALEV_4X].function = &scaler_nearest_4x;
    scalers[index].scale[SCALEV_4X].factor = 4;
    snprintf(scalers[index].scale[SCALEV_4X].name, SCALER_STR_MAX, "4X");
